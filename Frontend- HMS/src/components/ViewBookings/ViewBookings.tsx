...
function ViewBookings() {
    ...
    async function fetchData(pageNumber: any) {
        ...
        setIsLoading(true)
        try {
            const response = await axios.get(`http://localhost:8090/booking/getBookings/${pageNumber}?hotelId=${hotelId}`);
                ...
                <div className="col-12 mt-5">
                    <div className="card">
                        <div className="card-body">
                            <h4 className="header-title title"> ROOM BOOKINGS</h4>
                            {
                                bookings?.length > 0 ?
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className='delete-link-text'>
                                                                <a onClick={() => handleDelete(booking.id)}>Delete</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                )
